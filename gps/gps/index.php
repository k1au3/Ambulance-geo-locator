...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  if(isset($data -> operation)){
  	...
  	if(!empty($operation)){
        ...
        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> name) && isset($data -> user -> country) && isset($data -> user -> design) && isset($data -> user -> role) && isset($data -> user -> email)&& isset($data -> user -> password) && isset($data -> user -> branch)){
          ...
          if ($fun -> isEmailValid($email)) {
            ...
            echo $fun -> registerUser($name,$country,$design,$role,$email,$password,$branch);
