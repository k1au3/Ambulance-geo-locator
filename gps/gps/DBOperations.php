...
public function __construct() {
 ...
 public function insertData($name,$country,$email,$password,$design,$role,$branch){
    ...
    $sql = 'INSERT INTO employee SET unique_id =:unique_id,name =:name, country=:country,
    email =:email,  encrypted_password =:encrypted_password, salt =:salt,created_at = NOW(), design=:design,role=:role,branch=:branch ';

    $query = $this ->conn ->prepare($sql);
    $query->execute(array('unique_id' => $unique_id, ':name' => $name, ':country'=>$country, ':email' => $email,
     ':encrypted_password' => $encrypted_password, ':salt' => $salt,':role'=>$role,':design'=>$design,':branch'=>$branch));
 ...
 public function changePassword($email, $password){
    ...
    $sql = 'UPDATE employee SET encrypted_password = :encrypted_password, salt = :salt WHERE email = :email';
    $query = $this -> conn -> prepare($sql);
